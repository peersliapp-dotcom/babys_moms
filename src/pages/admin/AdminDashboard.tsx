  ...
  return (
    <div className="section-padding py-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Link to="/admin/contact-messages" className="card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-rose-100 flex items-center justify-center"><MailOpen size={22} className="text-rose-700" /></div>
            <div><h3 className="font-serif text-lg text-wine-800">Contact Form</h3><p className="text-sm text-wine-400">Messages from contact page</p></div>
          </div>
          <ChevronRight size={20} className="text-wine-300" />
        </Link>

        <Link to="/admin/subscribers" className="card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center gap-4">
            ...
            <div><h3 className="font-serif text-lg text-wine-800">Subscribers</h3><p className="text-sm text-wine-400">Newsletter signup list</p></div>
          </div>
          <ChevronRight size={20} className="text-wine-300" />
        </Link>
